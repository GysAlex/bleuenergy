    ...
    <section class="cta-section">
        <div class="container text-center" data-aos="fade-up">
            ...
            <div class="cta-buttons">
                ...
                <a href="/projet" class="btn btn-outline-light btn-lg">En Savoir Plus Sur Notre Projet</a>
                <a href="/contact" class="btn btn-outline-light btn-lg">Nous Contacter pour Collaborer</a>
            </div>
        </div>
    </section>
