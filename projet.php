...
<body>
    ...
    $projectData = [
        ...
        'description' => 'Nous vous présentons le parcours de notre projet : comment nous avons établi des partenariats et une stratégie de financement pour le mener à bien..',
        ...
        <div class="container">
            ...
            <div class="investment-content">
                ...
                <div class="investment-details slide-right">
                    <h3>Détail des investissements (en CFA)</h3>
