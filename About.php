...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p>Découvrez l'entreprise et les visionnaires derrière ce projet ambitieux, ainsi que notre présence active au cœur des défis énergétiques de demain.</p>
        </div>
    </section>
    ...
    <section class="section company-description">
        <div class="container">
            ...
            <div class="description-content animate-on-scroll">
                <p>Blue Energy est née de la conviction que les déchets urbains représentent une ressource énergétique inexploitée au sein des défis énergétiques actuels.</p>
                
                <p>Notre équipe dynamique place l'innovation et la durabilité au cœur de nos solutions, collaborant avec les municipalités et communautés pour transformer les déchets en opportunités.</p>
            </div>
        </div>
    </section>
